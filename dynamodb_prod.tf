...
resource "aws_dynamodb_table_item" "liked_items_ddb_init_item_prod" {
...
resource "aws_dynamodb_table_item" "users_liked_items_init_item_prod" {
  table_name = aws_dynamodb_table.users_liked_items_ddb_prod.name
  hash_key   = aws_dynamodb_table.users_liked_items_ddb_prod.hash_key
  range_key  = aws_dynamodb_table.users_liked_items_ddb_prod.range_key
...
# WARNING! WARNING! WARNING!
#########################################################################################################################
resource "aws_dynamodb_table_item" "js30_liked_items_init_setup" {
  lifecycle {
    ignore_changes = [item]
  }
